...
- <a name="toc_authorizejwtprototypeauthorizeauthz_token-cb"></a>[AuthorizeJWT.prototype.authorize](#authorizejwtprototypeauthorizeauthz_token-cb)
...
## AuthorizeJWT.prototype.authorize(authz_token, cb)
